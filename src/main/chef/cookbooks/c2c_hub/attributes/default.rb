...
default[:c2c][:hub][:has_internal_services] = false # node[:tomcat][:second_service] # Ideally we could source the tomcat property from this, but I could not make it work
